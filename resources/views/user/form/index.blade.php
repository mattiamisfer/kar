                        ...
                        <div class="row">
                            <div class="col-9">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Database Table</h4>
                            ...
                            <div class="col-3">
                                <a href="{{ route('user.products.create')}}"> <i class="dripicons-plus
                                    "> </i>ADD NEW</a>
                            </div>
                        </div>
                        <!-- end page title -->
                                        ...
                                        <div class="table-rep-plugin">
                                            <div class="table-responsive mb-0" data-pattern="priority-columns">
                                                <table id="tech-companies-1" class="table">
                                                    <thead>
                                                        <tr>
                                                            <th>DT. OF RECEIPT OF REQUIREMENT</th>
                                                <th>CLIENT</th>
                                                <th>COUNTRY</th>
                                                <th>PROJECT</th>
                                                ...
                                                <th>DELETE</th>
                                                    ...
                                                    <tbody>
                                                       ...
                                                       <tr>
                                                        <th>{{ $entry->receipt_requirement_date }}</th>
                                                        <td>{{ $entry->client_name }}</td>
                                                        <td>{{ $entry->country_name}}</td>
                                                        <td>{{ $entry->project_name }}</td>
                                                        <td>{{ $entry->num_of_requirement}}</td>
                                                        <td><a  class="d-flex align-items-center theme-icons shadow-sm p-2 cursor-pointer rounded btn  " href="{{ route('user.products.edit',$entry->id)}}"><i class="bx bx-edit"></i>  Edit  </a></td>
                                                    <td>
                                                        <form action="{{ route('user.products.destroy', $entry->id) }}" method="POST">
