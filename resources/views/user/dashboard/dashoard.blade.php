                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <h4 class="mb-3">
                                                     <span class="counter-value" data-target="{{ $totals }}">{{ $totals }}</span>
                                                </h4>
                            ...
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card card-h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Monthly Records</span>
                                                <h4 class="mb-3">
                                                    <span class="counter-value" data-target="{{ $months}}">{{ $months}}</span>
                                                </h4>
                                                <div class="text-nowrap">
                            ...
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card card-h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Today Records</span>
                                                <h4 class="mb-3">
                                                    <span class="counter-value" data-target="{{ $days}}">{{ $days}}</span>
                                                </h4>
                                                <div class="text-nowrap">
