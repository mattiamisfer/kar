                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <a href="{{ route('admin.slider.create')}}"> <i class="dripicons-plus
                                    "> </i>ADD NEW</a>
                            </div>
                        </div>
                        <!-- end page title -->
                                        ...
                                        <div id="datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="even">
                                                    ...
                                                    <td class="dtr-control sorting_1" tabindex="0">{{ $slider->sort_order}} </td>
                                                    <td><a  class="d-flex align-items-center theme-icons shadow-sm p-2 cursor-pointer rounded btn  " href="{{ route('admin.slider.edit',$slider->id)}}"><i class="bx bx-edit"></i>  Edit  </a></td>
