                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" name ="page" value="{{ $slider->page }}"
                                                        id="example-search-input">
                                                        @error('page')
                                                        <strong class="red">{{ $message }}</strong>
                                                @enderror
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="thumbnail" class="form-control" value="{{ $slider->image}}" type="text" name="image">
                                                  </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" name ="sort_order" value="{{ $slider->sort_order }}"
                                                    id="example-search-input">
                                                    @error('sort_order')
                                                    <strong class="red">{{ $message }}</strong>
                                            @enderror
