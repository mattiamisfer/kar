                        ...
                        <div class="col-12">
                         ...
                         @endif
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Create Sector</h4>
                                        ...
                                        <div class="col-lg-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input id="thumbnail" class="form-control" type="text" name="filepath1">
                                                      </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-12">
                                                ...
                                                <textarea id="my-editor" name="content" class="form-control">{!! old('content', 'Please Enter Content') !!}</textarea>
                                                @error('content')
                                                <strong class="red">{{ $message }}</strong>
                                        @enderror
                                            </div>
