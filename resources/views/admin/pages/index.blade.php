                        ...
                        <div class="row">
                            <div class="col-9">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Pages Table</h4>
                            ...
                            {{-- <div class="col-3">
                                <a href="{{ route('admin.news.create')}}"> <i class="dripicons-plus
                                    "> </i>ADD NEW</a>
                            </div> --}}
                        </div>
                        <!-- end page title -->
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                            ...
                                            <thead>
                                            <tr role="row">
                                                <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 136px;" aria-sort="ascending" aria-label="Name: activate to sort column descending">Page Name</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="even">
                                                    <td class="dtr-control sorting_1" tabindex="0"> {{ $page->name}}</td>
                                                     <td><a  class="d-flex align-items-center theme-icons shadow-sm p-2 cursor-pointer rounded btn  " href="{{ route('admin.page.edit',$page->id)}}"><i class="bx bx-edit"></i>  Edit  </a></td>
