                        ...
                        <div class="col-12">
                         ...
                         @endif
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Edit {{ Str::ucfirst($page->name)  }}</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Forms</a></li>
                                        <li class="breadcrumb-item active">{{ Str::ucfirst($page->name)  }}</li>
                                    </ol>
                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="thumbnail" class="form-control" type="text" name="image" value="{{ $page->logo}}">
                                                  </div>
