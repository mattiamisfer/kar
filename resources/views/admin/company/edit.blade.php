                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="thumbnail" class="form-control" type="text" name="image" value="{{ $company->logo }}">
                                                  </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" name ="sort_order" value="{{  $company->sort_order }}"
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" name ="website_url" value="{{  $company->url }}"
                                                    id="example-search-input">
                                                    @error('website_url')
                                                    <strong class="red">{{ $message }}</strong>
                                            @enderror
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-12">
                                                ...
                                                <textarea id="my-editor" name="content" class="form-control">{{ $company->content}}</textarea>
                                                @error('content')
                                                <strong class="red">{{ $message }}</strong>
                                        @enderror
                                            </div>
