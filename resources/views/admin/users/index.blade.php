                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <a href="{{ route('admin.user.create')}}"> <i class="dripicons-plus
                                    "> </i>ADD NEW</a>
                            </div>
                        </div>
                        <!-- end page title -->
                                                ...
                                                <th>DELETE</th>
                                                    ...
                                                    <tbody>
                                                       ...
                                                       <tr>
                                                        ...
                                                        <td><a  class="d-flex align-items-center theme-icons shadow-sm p-2 cursor-pointer rounded btn  " href="{{ route('admin.user.edit',$user->id)}}"><i class="bx bx-edit"></i>  Edit  </a></td>
                                                    <td>
