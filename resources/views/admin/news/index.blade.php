                        ...
                        <div class="row">
                            <div class="col-9">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">News Table</h4>
                                        ...
                                        <div id="datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="even">
                                                    ...
                                                    <td class="dtr-control sorting_1" tabindex="0">{{ $new->sort_order}} </td>
                                                    <td><a  class="d-flex align-items-center theme-icons shadow-sm p-2 cursor-pointer rounded btn  " href="{{ route('admin.news.edit',$new->id)}}"><i class="bx bx-edit"></i>  Edit  </a></td>
