                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" name ="sort_order" value="{{ $news->sort_order  }}"
                                                    id="example-search-input">
                                                    @error('sort_order')
                                                    <strong class="red">{{ $message }}</strong>
                                            @enderror
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="thumbnail" class="form-control" type="text" name="image" value="{{ $news->logo}}">
                                                  </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-12">
                                                ...
                                                <textarea id="my-editor" name="content" class="form-control">{{ $news->content}}</textarea>
                                                @error('content')
                                                <strong class="red">{{ $message }}</strong>
                                        @enderror
                                            </div>
